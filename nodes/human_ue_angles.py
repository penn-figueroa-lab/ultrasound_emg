...
class Ellipsoid:
    ...
    def __init__(self, dt) -> None:
        ...
        self.right_ue_ang_pub = rospy.Publisher('/human/vis/ellipsoid_r', Float64MultiArray, queue_size=10)
        self.left_ue_ang_pub =  rospy.Publisher('/human/vis/ellipsoid_l', Float64MultiArray, queue_size=10)
